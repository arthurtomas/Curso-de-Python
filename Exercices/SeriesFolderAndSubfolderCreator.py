...
if dir_exists(f"C:\\Users\\Barzilay\\Desktop\\{m_folder}"):
    ...
    if answer in "Nn":
        ...
        delete_folder(f"C:\\Users\\Barzilay\\Desktop\\{m_folder}")
...
elif not dir_exists(f"C:\\Users\\Barzilay\\Desktop\\{m_folder}"):
    create_folder(f"C:\\Users\\Barzilay\\Desktop\\{m_folder}")
    for i in range(1, num_sub_folders + 1):
        create_folder(f"C:\\Users\\Barzilay\\Desktop\\{m_folder}\\{i}° Season")
